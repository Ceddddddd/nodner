...
namespace WindowsFormsApp1
{
    public partial class Form3 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string connectionString = "Data Source=DESKTOP-2DKQGSL\\SQLEXPRESS;Initial Catalog=Rendon;Integrated Security=True";
            string query = "INSERT INTO NotebooksAndPaper (notebook_paper_id, item_name, quantity, price, category_id) VALUES (@id, @item, @qty, @price, @cat_id)";
        ...
        private void dataGridView1_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.RowIndex < dataGridView1.Rows.Count)
            {
                ...
                textBox1.Text = selectedRow.Cells["notebook_paper_id"].Value.ToString();
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            {
                string connectionString = "Data Source=DESKTOP-2DKQGSL\\SQLEXPRESS;Initial Catalog=Rendon;Integrated Security=True";
                string query = "UPDATE NotebooksAndPaper SET item_name = @item, quantity = @qty, price = @price, category_id = @cat_id WHERE notebook_paper_id = @idToUpdate";
        ...
        private void button4_Click_1(object sender, EventArgs e)
        {
            ...
            string connectionString = "Data Source=DESKTOP-2DKQGSL\\SQLEXPRESS;Initial Catalog=Rendon;Integrated Security=True";
            string query = "DELETE FROM NotebooksAndPaper WHERE notebook_paper_id = @idToDelete";
